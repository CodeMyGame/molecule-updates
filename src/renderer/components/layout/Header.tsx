  ...
  return (
    ...
    <header className="pos-header">
      <div className="flex items-center gap-2 min-w-0">
        <span className="text-xs font-bold text-gray-800 dark:text-gray-100 tracking-tight whitespace-nowrap leading-none">
          {restaurantName}
        </span>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center min-w-0">
        ...
        <div className={`flex items-center gap-3.5 ${slotHasContent ? 'hidden' : ''}`}>
          <div className="flex items-center gap-1 text-[11px] text-gray-600 leading-none">
            <Clock size={11} />
        ...
        <div className="relative flex items-center">
          ...
          {showBellMenu && createPortal(
            <>
              ...
              <div className="fixed top-9 right-2.5 w-[380px] max-w-[92vw] bg-white border border-gray-200 rounded-2xl shadow-2xl z-[99999] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
